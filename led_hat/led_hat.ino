  ...
  for (int c = 0; c < cycles; c++) {
    for (int p = 0; p < 360 / 10; p++) {
      ...
      for (int col = 0; col < 8; col++) {
        ...
        for (int row = 0; row < map(values[col], 0, 100, 2, 9); row++) {

          // 0 < col < 3     && 2 < row < 8
          if ((row % 2) == 0) {
            pixels.setPixelColor(row * 8 + (7 - col), pixels.Color(row * 30,  96 - 10 * row, 0));
          } else {
            pixels.setPixelColor((row * 8) + 7 - col, pixels.Color(row * 30,  96 - 12 * row, 0));
          }
  ...
  for (int c = 0; c < cycles; c++) {
    ...
    for (int p = 0; p < 360 / 10; p++) {
      ...
      for (int col = 0; col < 4; col++) {
        ...
        for (int row = 0; row < map(values[col], 1, 100, 2, 9); row++) {
          ...
          if ((row % 2) == 0) {
            ...
            pixels.setPixelColor((row * 8) + 7 - (2 * col), pixels.Color(0,  row * 30, 96 - 12 * row));
            pixels.setPixelColor((row * 8) + 7 - (2 * col + 1), pixels.Color(0, row * 30,  96 - 12 * row));
          }
